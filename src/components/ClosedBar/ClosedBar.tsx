 ...
 * ClosedBar
 *
 * Fixed red bottom bar shown when the restaurant is closed for online ordering
 * (scheduler cases 4–9). Displays the next session opening time.
 *
 * Messages (mirror scheduler type string logic exactly):
 *   TODAY / ALL  → "We are closed. We will begin accepting online orders at [time] [tz]."
 *   TOMORROW     → "We are closed. Online ordering will resume TOMORROW at [time] [tz]."
 *   other day    → "We are closed. Online ordering will resume on [day] at [time] [tz]."
 *
 * Positioning:
 ...
 *   when ActiveOrdersBar is present.
 */
...
/** Disclaimer SVG — inline so it flows with the text, inherits currentColor */
